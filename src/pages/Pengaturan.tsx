...
export default function Pengaturan() {
  const [activeTab, setActiveTab] = useState<'system' | 'master'>('system');
    ...
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="flex space-x-1 rounded-xl bg-slate-100 p-1">
        <button
          ...
          className={`flex items-center justify-center w-1/2 rounded-lg py-2.5 text-sm font-medium leading-5 transition-all
