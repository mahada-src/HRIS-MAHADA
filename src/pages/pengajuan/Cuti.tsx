        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4 max-w-2xl">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-slate-700">Jenis Cuti</label>
                <input required type="text" value={leave_type} onChange={e => setLeave_type(e.target.value)} className="w-full rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm transition-all focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20" />
              </div>
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-slate-700">Alasan Cuti</label>
